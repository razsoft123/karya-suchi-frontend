...
export default function HeroSection() {
  return (
    <section className="w-full min-h-dvh flex justify-center items-center relative">
      <div
        className={`absolute top-0 left-0 w-140 h-140 -z-10 ${styles.radialGradientBgTop}`}
      ></div>
      <div
        className={`absolute bottom-0 right-0  w-140 h-140 -z-10 ${styles.radialGradientBgBottom}`}
      ></div>
      <div className="font-inter flex gap-4 justify-center items-center flex-col max-w-3xl">
        ...
        <p className="font-inter text-app-body text-center text-lg font-normal">
